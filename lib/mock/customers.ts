...
export function getCustomers(): Customer[] {
  return [
    ...
    { id: 'cu6', name: 'Maya R.', phone: '+971559911228', city: 'Dubai', ltv_aed: 8_900, orders: 2, last_at: '2026-05-23', stores: ['whatsapp'], segment: 'new', wallet_balance_aed: 0 },
    { id: 'cu7', name: 'Hessa K.', phone: '+971508811276', city: 'Dubai', ltv_aed: 41_200, orders: 9, last_at: '2026-05-23', stores: ['woocommerce', 'whatsapp'], segment: 'vip', wallet_balance_aed: 800 },
