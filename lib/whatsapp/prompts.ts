/**
 * Clean TypeScript exports of the WhatsApp Desk AI prompts.
 *
 * Source: prompts/raw-prompts.txt (the original Gemini-written prompts).
 * That file was malformed (open template literals) and excluded from
 * compilation; the contracts below are the same content, restored.
 */
